...
export const LiveEventLoopbackButtonContent = (
  <>
    <svg
      width="16"
      height="16"
      ...
      className="event-content-loopback-btn-content"
    >
      <path
...
const LiveEventLoopbackButton: React.FC<{
  ...
  return (
    <div
      className={`event-content-loopback-btn ${
    ...
    >
      ...
      >
        {LiveEventLoopbackButtonContent}
      </button>
    </div>
  )
})
